...
if __name__ == "__main__":
    ...
    # create dataset
    train_dataset, val_dataset, data_name, logger_freq, max_epochs = return_dataset(
        control
    )    # , n_samples=n_samples)
    ...
    experiment = 'oft_{}_{}_eps_{}_pe_diff_mlp_r_{}'.format(
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath='oft-control/log/image_log_' + experiment,

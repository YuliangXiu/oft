...
from diffusers.utils import BaseOutput, logging, is_compiled_module
...
class MyPipeline(StableDiffusionControlNetPipeline):
    ...
    def __call__(
        ...
        guess_mode = guess_mode or controlnet.config.global_pool_conditions
...
class ControlNetModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        return ControlNetOutput(mid_block_res_sample=mid_block_res_sample)

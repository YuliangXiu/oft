...
from controlnet import MyPipeline
...
def log_validation(
    ...
    for idx in range(args.num_validation_images):
        ...
        validation_prompt = validation_prompt.replace("man", "full-body yuliang man")
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--oft_model_name_or_path",
        type=str,
        default=None,
        help="Path to pretrained oft model or model identifier from huggingface.co/models."
    )
